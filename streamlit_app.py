...
from places import PLACE_PRESETS, PRESET_NAMES, get_preset
...
with st.form("birth_form", clear_on_submit=False):
    ...
    with col2:
        time_unknown = st.checkbox(
            ...
            help="Αν ενεργό, χρησιμοποιείται μεσημέρι (12:00) και δεν υπολογίζονται Ωροσκόπος/οίκοι.",
        )
        try:
    ...
    if time_unknown:
        st.caption(
            "📌 Χωρίς ακριβή ώρα: υπολογισμός στις **12:00** (τοπική κατά προσέγγιση). "
            "Ο Ωροσκόπος και οι οίκοι απαιτούν ώρα + τόπο."
        )
