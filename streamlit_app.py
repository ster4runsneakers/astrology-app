...
<div style="text-align:center">
  ...
  <p style="color:#94a3b8;font-size:0.95rem;margin:0 auto;max-width:28rem">
    Ζώδιο, ημερήσια πρόβλεψη, γενέθλιος χάρτης και ανάλυση προσωπικότητας — χωρίς επί πληρωμή APIs.
  </p>
</div>
""",
    unsafe_allow_html=True,
...
# Personality analysis (deterministic Greek text from placements)
st.subheader("Ανάλυση προσωπικότητας")
try:
    analysis = analyze_personality(chart, profile)
    with st.expander("Δες την ανάλυση", expanded=True):
